...
// ---------- MQTT ----------
const char* mqtt_server = "10.13.47.16";  // Mosquitto / Cloud broker
...
#define BLYNK_TEMPLATE_ID "TMPL6KM7Lch7W"
#define BLYNK_TEMPLATE_NAME "SAADs DHT"
#define BLYNK_AUTH_TOKEN "G8LkZV9Qp_ZWCswos1yYo3j7iPvtlrfb"
